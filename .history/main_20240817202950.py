...
def get_db_connection(config):
    ...
    return connection
def get_login_data():
    # login_data 데이터베이스에 연결
    connection = mysql.connector.connect(**db_login_data_config)
...
def get_sensor_data():
    ...
    query = "SELECT * FROM some_table_in_sensor_data1"
    cursor.execute(query)
    data = cursor.fetchall()
...
def step2():
    ...
    return render_template('step2.html',data=sensor_data)
